...
dlmwrite('IO/mylake_initial_concentrations.txt', ...
 ...
 zeros(length(MyLake_results.zz),1), ...  % In_TPz_sed
 zeros(length(MyLake_results.zz),1), ...  % In_Chlz_sed
 zeros(length(MyLake_results.zz),1), ...   % MyLake_results.FIM(:,end)
 zeros(length(MyLake_results.zz),2), ...  % ice0
