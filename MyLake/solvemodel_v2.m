...
%     fm = (tanh(-delta) + 1)/2;
    ...
    CO2_over_sat = CO2z - CO2_solubility;
    ...
    R35a = k_pdesorb_c .* Pz .* Al3z; % NOTE: No separate pool for sorbed P on aluminum in WC
    R35a = 0; % NOTE: No separate pool for sorbed P on aluminum in WC
    R35b = 0; % NOTE: the rate is unknown
