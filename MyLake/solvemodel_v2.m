...
sediment_results = {O2_sediment_zt,     'Oxygen (aq)';
    ...
    z_sediment,         'z';
    R_values_sediment_zt,'R values';
    Bioirrigation_sediment_zt, 'Fluxes of bioirrigation';
    MyLake_params,       'MyLake Params important for sediment';
    sediment_params,     'Sediments params';
    SWI_fluxes_sediment_zt, 'SWI fluxes from WC to sediments';
    sediment_integrated_over_depth_fluxes_t, 'Flux integrated over depth';
...
MyLake_results = {
    ...
    O2zt,                   'O2zt' ;
    d_O2zt,                 'd_O2zt';
    int_R_O2dz,             'O2 R integrated over the depth';
    NO3zt,                  'NO3zt'  ;
    NH4zt,                  'NH4zt'  ;
    SO4zt,                  'SO4zt '  ;
    HSzt,                   'HSzt '  ;
    ...
    diatomzt,               'diatomzt  '  ;
    O2_diffzt,              'O2_diffzt ' ;
    O2_sat_relt,            'O2_sat_relt ' ;
    O2_sat_abst,            'O2_sat_abst ' ;
    Qzt_sed,                'Qzt_sed ' ;
    lambdazt,               'lambdazt ' ;
    P3zt_sed,               'P3zt_sed ' ;
    P3zt_sed_sc,            'P3zt_sed_sc ' ;
    His,                    'His ' ;
    MixStat,                'MixStat ' ;
    CDOMzt,                 'CDOMzt';
    DOCzt1,                 'DOCzt1';
