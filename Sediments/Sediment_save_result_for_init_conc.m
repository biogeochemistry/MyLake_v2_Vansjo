...
dlmwrite(file_name, ...
[sed_res.params.x', ...
sed_res.concentrations.OM1(:,end), ...
sed_res.concentrations.OM2(:,end), ...
sed_res.concentrations.DOM1(:,end), ...
sed_res.concentrations.DOM2(:,end), ...
...
sed_res.concentrations.H2CO3(:,end)], 'delimiter', '\t', '-append')
