...
function [sediment_params] = params(max_depth, temperature)
    ...
    sediment_params.k_apa_pre = data{2}(30);
    sediment_params.k_apa_dis = data{2}(31);
    sediment_params.K_apa = data{2}(32);
    sediment_params.k_CaCO3_pre = data{2}(33);
    sediment_params.k_CaCO3_dis = data{2}(34);
    sediment_params.K_CaCO3 = data{2}(35);
    sediment_params.k_FeCO3_pre = data{2}(36);
    sediment_params.k_FeCO3_dis = data{2}(37);
    sediment_params.K_FeCO3 = data{2}(38);
    sediment_params.k_viv_pre = data{2}(39);
    sediment_params.k_viv_dis = data{2}(40);
    sediment_params.K_viv = data{2}(41);
    sediment_params.k_oms = data{2}(42);
    sediment_params.k_tsox = data{2}(43);
    sediment_params.k_FeSpre = data{2}(44);
