%% Thils will average water column over water depth chosen by the user. 
...
for variable = 1:3
    ...
    temp = fn_agg_t_depth_averaged(variable, 1, 2); % variable name, top boundary, botton boundary for average
