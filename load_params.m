...
sediment_params = {
    ...
    48,     'n_ts',                 % 73           % (100 is the minimum, testing 48) number of time steps during 1 day (fixed time step of MyLake) for chemical and sediment module (the modules should be in sync)
