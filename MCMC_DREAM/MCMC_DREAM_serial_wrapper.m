...
% Setting MCMC algorithm parameters
MCMCPar.n           = 1;       % Number of chains
...
MCMCPar.delta       =  0;       % Number of different pairs of chains to look at. set to 0 original 3Must be equal or less than (MCMCPar.n-1)/2
...
MCMCPar.tmax        = 540;     % Stop after this many iterations
MCMCPar.burnin      = 200;     % End of burninperiod.
plt                 = 100;       %Plot every plth iteration
outlierc 			= 0;		% To count the number of outliers removed during burnin. 

Priors(44).name = {'Error variance O2'};
Priors(45).name = {'Error variance T'};
Priors(44).min  = 1e-3;
Priors(44).max  = 5e3;
Priors(45).min  = 1e-3;
Priors(45).max  = 1e2;
