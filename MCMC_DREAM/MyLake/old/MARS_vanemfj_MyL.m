...
lake='Vansjo-vanemfjorden';
year = 1983
m_start=[1983, 1, 4]
m_stop=[2014, 5, 31]
csvwrite('dateinformation.csv', [m_start; m_stop])
inputfile='vanem_INCAP_input.txt'
initfile='vanem_init.txt' % Tuomo's work
parafile='vanem_para.txt'
...
%% Total P
tlims=[datenum([1983,4,1]) datenum([2014,5,1])];
